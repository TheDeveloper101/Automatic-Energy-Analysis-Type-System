...
{}
{\alpha \hookrightarrow st \vdash \alpha \Downarrow D(st)}
\sai{im abusing notation and using D(st) to represent the set of states to the left of the downgrade policy}
