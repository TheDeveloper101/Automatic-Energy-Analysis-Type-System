...
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = s_i \\ \forall i\in \{s\}, s_i \leq st
}
{ 
...
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = s_i \\ \forall i\in \{s\}, s_i \hookrightarrow st \in p(D)
}
{ 
...
\inferrule*[left=T-Transition]
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = s_i \\ \forall i\in \{s\}, s_i \leq st \\ C = \max(\m{cost}(s_i, st))
}
{ 
...
\inferrule*[left=T-Downgrade]
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = s_i \\ \forall i\in \{s\}, s_i \hookrightarrow st \in p(D) \\ C = \max (\m{cost}(s_i, st) )
}
{ 
