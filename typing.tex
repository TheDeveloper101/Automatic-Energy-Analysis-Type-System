...
\[
\begin{array}{lcll}
\text{Peripheral Declarations: }p & \bnfdef & \text{id} \{\langle s_{0},s_{1},\ldots,s_{n}\rangle, <, D \}, p_1 \ \vert \ \cdot 
\end{array}
\]
\[
\begin{array}{lcll}
\text{Declarations: }d & \bnfdef & \text{fn } f(x, p) : (\tau_1, s_1) \rightarrow (\tau_2, s_2) \  \{c; ret := e\}, d_1 \ \vert \ \cdot
\end{array}
\]
\[
\begin{array}{lcll}
\text{Commands: }c & \bnfdef & e & \text{(expression)} \\ & \bnfalt & \text{let } x = e & \text{(let)} \\ 
  & \bnfalt &\text{let } x = f(e, p) & \text{(function call)} \\ & \bnfalt & \text{atomic}\{p_1:\{s_1\}, \dots, p_n:\{s_n\} \}(c) & \text{(atomic)} \\ 
...
\\
\textit{Peripheral Context} & \pctx & \bnfdef &  p \rightarrow \{s_\}, \pctx \bnfalt \cdot
\end{array}
\]
...
{
\tctx(f) = (\tau_1, s_1) \rightarrow (\tau_2, s_2) \\ \tctx,\pctx \vdash e : \tau_1 \\ \pctx(p) = \{s_i\} \\ \forall i\in \{s\}, s_i \leq s_1
}
{
...
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = \{s\} \\ \forall i\in \{s\}, s_i \leq st
}
{ 
...
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = \{s\} \\ \forall i\in \{s\}, s_i \hookrightarrow st \in p(D)
}
{ 
...
\inferrule*[left=T-If]
{
\tctx,\pctx \vdash e : \text{bool} \\ \tctx,\pctx \vdash c_1 : \tau \Rightarrow \tctx_1, \pctx_1 \\ \tctx,\pctx \vdash c_2 : \tau \Rightarrow \tctx_2, \pctx_2 \\ \tctx^* = \tctx_1 \cup \tctx_2 \\ \pctx^* = \pctx_1 \lub \pctx_2 
}
{
...
{
\forall i, \pctx(p_i) \subseteq \{s_i\} \\ \tctx,\pctx \vdash c : \tau \Rightarrow \tctx', \pctx' 
}
{ 
\tctx,\pctx,S \vdash \text{atomic}\{p_1: \{s_1\}, \dots, p_n: \{s_n\} \}(c) : \tau \Rightarrow \tctx', \pctx'
}

\inferrule*[left=T-FunDecl]
{
\tctx[x : \tau_1], \pctx[p: s_1] \vdash c: \tau_2 \Rightarrow \tctx', \pctx[p : s_2] \\ \tctx', \pctx[p: s_2] \vdash e : \tau_2
}
{ \tctx,\pctx \vdash \text{fn } f(x, p) : (\tau_1, s_1) \rightarrow (\tau_2, s_2) \  \{c; ret := e\} \Rightarrow \tctx[f \mapsto (\tau_1, s_1) \rightarrow (\tau_2, s_2)], \pctx
}
...
\inferrule*[left=T-Call]
{
\tctx(f) = (\tau_1, s_1) \xrightarrow{C_f} (\tau_2, s_2) \\ \tctx,\pctx \vdash e : \tau_1 \\ \pctx(p) = \{s_i\} \\ \forall i\in \{s\}, s_i \leq s_1 \\ C = C_f + C_a + \max(\m{cost}(s_i, s_1))
}
{
...
\inferrule*[left=T-Transition]
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = \{s\} \\ \forall i\in \{s\}, s_i \leq st \\ C = \max(\m{cost}(s_i, st))
}
{ 
...
\inferrule*[left=T-Downgrade]
{
\tctx,\pctx \vdash x : \rho \\ \pctx(x) = \{s\} \\ \forall i\in \{s\}, s_i \hookrightarrow st \in p(D) \\ C = \max (\m{cost}(s_i, st) )
}
{ 
...
\inferrule*[left=T-If]
{
\tctx,\pctx \vdash e : \text{bool} \\ \tctx,\pctx \vdash c_1 : \tau \xrightarrow{C_1} \tctx_1, \pctx_1 \\ \tctx,\pctx \vdash c_2 : \tau \xrightarrow{C_2} \tctx_2, \pctx_2 \\ \tctx^* = \tctx_1 \cup \tctx_2 \\ \pctx^* = \pctx_1 \lub \pctx_2 \\ C = \max(C_1, C_2)
}
{
...
\inferrule*[left=T-Seq]
{
\tctx,\pctx \vdash c_1 : \tau_1 \xrightarrow{C'} \tctx', \pctx' \\ \tctx',\pctx' \vdash c_2 : \tau_2 \xrightarrow{C''} \tctx'', \pctx'' \\ C'_{\max} = \m{cost}(\pctx) \\ C''_{\max} = \m{cost}(\pctx') \\ C = C' + C'' + C'_{\max} + C''_{\max}
}
{
...
\inferrule*[left=T-FunDecl]
{
\tctx[x : \tau_1], \pctx[p: s_1] \vdash c: \tau_2 \xrightarrow{C_1} \tctx', \pctx[p : s_2] \\ \tctx', \pctx[p: s_2] \vdash e : \tau_2, C_2 \\ C = C_1 + C_2
}
{ \tctx,\pctx \vdash \text{fn } f(x, p) : (\tau_1, s_1) \rightarrow (\tau_2, s_2) \  \{c; ret := e\} \Rightarrow \tctx[f \mapsto (\tau_1, s_1) \xrightarrow{C} (\tau_2, s_2)], \pctx
}
