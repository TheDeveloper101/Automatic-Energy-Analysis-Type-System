...
We define [$\alpha$] to be a stack of type variables, with a lookup $A(p)$ referring to the top of it's stack, $\alpha :: A(p)$ pushing $\alpha$ to the top of the stack and $A[p]$ to refer to the current stack of type variables for peripheral $p$. 
...
{
 \alpha_1 = A_1(p) \\ \alpha_2 = A_2(p) \\ A_1[p] = \alpha_1 :: [\alpha^1] \\ A_2[p] = \alpha_2 :: [\alpha^2] \\ \alpha_3 \text{ fresh} \\ A'[p] = \alpha_3 :: [\alpha^3] \\ \alpha_1, \alpha_2 \vdash \Phi_1 \oplus \Phi_2 = \Phi' \\ \Phi_1, \Phi_2 \vdash [\alpha^1] \uplus [\alpha^2]
}
{
