...
\begin{mathpar}
    ...
    \inferrule*[left=NotEq-Type-Variable]{
     \alpha_1 \neq \alpha_2 \\ \alpha_3 \text{ fresh} \\ \Phi_3|_{\alpha} = \Phi_1|_{\alpha} \wedge \Phi_2|_{\alpha} \wedge (\alpha_3 = \alpha_1 \vee \alpha_2)
    }{
    \alpha_1, \alpha_2 \vdash \Phi_1|_{\alpha}, \Phi_1' \oplus \Phi_2|_{\alpha}, \Phi_2' = \Phi_3|_{\alpha}, \Phi_3'
    }
\end{mathpar}
...
{
 \alpha_1 = A_1(p) \\ \alpha_2 = A_2(p) \\ A_1[p] = \alpha_1 :: A_1'[p] \\ \\ A_2[p] = \alpha_2 :: A_2'[p] \\ \alpha_1, \alpha_2 \vdash \Phi_1 \oplus \Phi_2 = \Phi' \\ \Phi_1, \Phi_2 \vdash A_1'[p] \uplus A_2'[p]
}
{
...
We also define $\Phi_f \models \alpha$ to be the solution of $\alpha$ that satisfies $\Phi_f$ assuming such a solution exists. 
...
{ \alpha_{\text{in}} \text{ fresh} \\ A = p : [\alpha_{\text{in}}] \\ \tctx, A, \cdot \vdash c \rightarrow A_f, \Phi_f \\ A_f(p) = \alpha_{\text{out}} \\ \Vec{s}_o = \Phi_f \models \alpha_{\text{out}} \\ \Vec{s}_i = \Phi_f \models \alpha_{\text{in}} \\ \tau_f = (\tau_1, \Vec{s}_i) \rightarrow (\tau_2, \Vec{s}_o)
} 
