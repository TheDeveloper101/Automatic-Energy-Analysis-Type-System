...
\begin{figure}
   ...
   \[
    \begin{array}{lcll}
     ...
     & \bnfalt & C(p : \alpha)  \\ & \bnfalt & \m{max}(\varepsilon_1, \varepsilon_2) \ \\ & \bnfalt & C[\alpha \mapsto st] \\ & \bnfalt & C \\ & \bnfalt & \varepsilon_1 + \varepsilon_2 
\end{array}
   \]
...
\label{fig: syntax}
\end{figure}
Our type system uses additional constructs detailed in Figure ~\ref{fig:constructs}
\begin{figure}
    \centering
\[
\begin{array}{llcl}
